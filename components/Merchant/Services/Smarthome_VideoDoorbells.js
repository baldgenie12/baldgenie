...
import { Smart_Home_Video_Doorbells } from '../../../utils/ServicesCategories'
import videosContext from '../../../context/videos/videosContext'


export const Smarthome_VideoDoorbell = () => {
    const CATEGORY ='Smart_Home_Video_Doorbells_Context'

    const { setSmart_Home_Video_Doorbells_Context } = useContext(videosContext)
    const [servicesArray, setservicesArray] = useState([])


    const stateObj = [
        { category:"Smart_Home_Video_Doorbells_Context", servicename: 'Video Doorbell Installation',
            selected: false,
            amount: ''
        },
        { category:"Smart_Home_Video_Doorbells_Context", servicename: 'Video Doorbell Support',
            selected: false,
            amount: ''
        }
    ]
    ...
    const setDataToContext = () => {
        ...
        setSmart_Home_Video_Doorbells_Context([...servicesArray])
    }
    return (
        <div>
            ...
            {Smart_Home_Video_Doorbells.map((subcategory, index) => {
                return (

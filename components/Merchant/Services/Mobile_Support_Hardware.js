...
export const Mobile_Support_Hardware = () => {
    const CATEGORY ='Mobiles_Hardware_Context'
    const { setMobiles_Hardware_Context } = useContext(videosContext)
    const [servicesArray, setservicesArray] = useState([])


    const stateObj = [
        { category:"Mobiles_Hardware_Context", servicename: 'Screen Replacement', selected: false, amount: '' },
        { category:"Mobiles_Hardware_Context", servicename: 'Water Damage', selected: false, amount: '' },
        { category:"Mobiles_Hardware_Context", servicename: 'Water Damage', selected: false, amount: '' },
        { category:"Mobiles_Hardware_Context", servicename: 'Sound Issue', selected: false, amount: '' },
        { category:"Mobiles_Hardware_Context", servicename: 'Touch Screen Not Working',
            selected: false,
            amount: ''
        },
        { category:"Mobiles_Hardware_Context", servicename: 'Mobile / Tablet Others',
            selected: false,
            amount: ''
        }
    ]
    ...
    const setDataToContext = () => {
        ...
        setMobiles_Hardware_Context([...servicesArray])
    }
    return (
        <div>
            ...
            {/* ServiceItems */}
            {Mobiles_Hardware.map((subcategory, index) => {
                return (

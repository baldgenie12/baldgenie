        ...
        <div>
           ...
           <h1 className='my-6 mt-14 text-lg font-semibold'>Wifi and Network:</h1>
            ...
            <div className='category'>
                <input className='scale-150' type="checkbox" id="New Wifi Connection Setup" name="New Wifi Connection Setup" />
            ...
            <div className='category'>
                <input className='scale-150' type="checkbox" id="Wifi & network support" name="Wifi & network support" />
            ...
            <div className='category'>
                <input className='scale-150' type="checkbox" id="Wifi Signal Extension" name="Wifi Signal Extension" />

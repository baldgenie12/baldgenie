...
import { Home_Security_Cameras } from '../../../utils/ServicesCategories'
import videosContext from '../../../context/videos/videosContext'


export const Home_Security_Camera = () => {
    const CATEGORY ='Home_Security_Cameras_Context'

    const { setHome_Security_Cameras_Context } = useContext(videosContext)
    const [servicesArray, setservicesArray] = useState([])


    const stateObj =[
        { category:"Home_Security_Cameras_Context", servicename: 'Smart Security Camera Installation',
            selected: false,
            amount: ''
        },
        { category:"Home_Security_Cameras_Context", servicename: 'Smart Security Camera Support',
            selected: false,
            amount: ''
        }
    ]
    ...
    const setDataToContext = () => {
        ...
        setHome_Security_Cameras_Context([...servicesArray])
    }
    return (
        <div>
            ...
            {/* ServiceItems */}
            {Home_Security_Cameras.map((subcategory, index) => {
                return (

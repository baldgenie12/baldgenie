...
import { Home_Security_Alarms } from '../../../utils/ServicesCategories'
import videosContext from '../../../context/videos/videosContext'


export const Home_Security_Alarm = () => {
    const CATEGORY ='Home_Security_Alarms_Context'

    const { setHome_Security_Alarms_Context } = useContext(videosContext)
    const [servicesArray, setservicesArray] = useState([])


    const stateObj = [
        {
            category: "Home_Security_Alarms_Context", servicename: 'Alarm System Installation & Setup',
            selected: false,
            amount: ''
        },
        { category: "Home_Security_Alarms_Context", servicename: 'Alarm System Support', selected: false, amount: '' }
    ]
    ...
    const setDataToContext = () => {
        ...
        setHome_Security_Alarms_Context([...servicesArray])
    }
    return (
        <div>
            ...
            {/* ServiceItems */}
            {Home_Security_Alarms.map((subcategory, index) => {
                return (

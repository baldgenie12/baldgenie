...
export const ServicesLists = () => {
    ...
    return (
        <div className='text-gray-600   '>
            ...
            <div className='px-1.5 flex space-x-4  m-4  overflow-x-scroll scrollbar-hide items-center    ml-3 lg:ml-2.5  '>
                {categories.map(item => {
                    return (
            ...
            <div className='px-2 sm:mt-4 flex flex-wrap  items-center justify-start text-xs sm:text-sm space-x-2 text-gray-400' >
                ...
                <button className="bg-grey-light hover:text-red-500  hover:bg-grey text-grey-darkest font-semibold p-1 px-2  inline-flex items-center border-2 border-gray-300 rounded mt-1 lg:mt-0">
                    <XCircleIcon className='h-4' />
                    <span>Releavance</span>
                </button>
            </div>

            <div className='px-4  lg:pr-28'>
                {listItemData.map(item => {
                    return (

                        <div key={item.description} className='border-2 p-4  border-gray-200  my-6 rounded-lg hover:bg-slate-200 '>
                            ...
                            <div className='md:text-sm text-xs pt-4  mt-2 flex flex-col lg:flex-row lg:justify-between justify-center items-start  space-y-1 '>
                                <div className=''>
